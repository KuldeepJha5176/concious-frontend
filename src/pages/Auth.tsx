...
export function Auth() {
  ...
  return (
    <div className="flex md:flex-row flex-col justify-center gap-2">
      <h1 className="absolute top-0  text-center text-gray-400 text-md text-xs  rounded p-2">
        Hosted on free instance, which may delay requests by 50 seconds or more
        due to inactivity, please wait.{" "}
      </h1>
